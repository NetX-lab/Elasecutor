...
public class Blkio extends Common {
  ...
  public static final String PROP_BLKIO_THROTTLE_READ_BPS_DEVICE = "io.throttle.read_bps_device";
  public static final String PROP_BLKIO_THROTTLE_WRITE_BPS_DEVICE = "io.throttle.write_bps_device";
  public static final String PROP_BLKIO_THROTTLE_READ_IOPS_DEVICE = "io.throttle.read_iops_device";
  public static final String PROP_BLKIO_THROTTLE_WRITE_IOPS_DEVICE = "io.throttle.write_iops_device";
  public static final String PROP_BLKIO_THROTTLE_IO_SERIVICED = "io.throttle.io_serviced";
  public static final String PROP_BLKIO_THROTTLE_IO_SERIVICE_BYTES = "io.throttle.io_service_bytes";
  public static final String PROP_BLKIO_THROTTLE_IO_QUEUED = "io.throttle.io_queued";

  public static final String PROP_BLKIO_RESET_STATS = "bio.reset_stats";
  public static final String PROP_BLKIO_TIME = "io.time";
  public static final String PROP_BLKIO_SECTORS = "io.sectors";
  public static final String PROP_BLKIO_AVG_QUEUE_SIZE = "io.avg_queue_size";
  public static final String PROP_BLKIO_GROUP_WAIT_TIME = "io.group_wait_time";
  public static final String PROP_BLKIO_EMPTY_TIME = "io.empty_time";
  public static final String PROP_BLKIO_IDLE_TIME = "io.idle_time";
  public static final String PROP_BLKIO_DEQUEUE = "io.dequeue";
  public static final String PROP_BLKIO_IO_SERIVICED = "io.io_serviced";
  public static final String PROP_BLKIO_IO_SERIVICE_BYTES = "io.io_service_bytes";
  public static final String PROP_BLKIO_IO_SERIVICE_TIME = "io.io_service_time";
  public static final String PROP_BLKIO_IO_WAIT_TIME = "io.io_wait_time";
  public static final String PROP_BLKIO_IO_MERGED = "io.io_merged";
  public static final String PROP_BLKIO_IO_QUEUED = "io.io_queued";
